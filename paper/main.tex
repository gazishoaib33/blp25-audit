...
0.02\,pp wins only 51.5\% of bootstrap resamples. Five of our ten systems never
predict \textsc{Sexism} at all. We release all audit code.
\end{abstract}
...
score exactly $0.000$ F1 on \textsc{Sexism}: they never predict the class at
all. The system with the best macro-F1 (0.5019) and much the best
\textsc{Sexism} F1 (0.115) ranks only \emph{fourth} of ten on micro-F1. Micro
and macro rankings agree weakly (Kendall $\tau=0.467$, $p=.073$). Optimising the
reported metric does not merely fail to reward rare-class detection---in our
pool it actively demotes the system that does it best.
